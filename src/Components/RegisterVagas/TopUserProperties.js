...
export default TopUserProperties = props => {
  prop = () => {
    ...
    try {
      ...
      return (
        <Text style={{fontWeight: '500', fontSize: 16}}>Hallyson Jean </Text>
      );
    }
  };
  return (
    <View
      ...
      <View
        ...
        />
        <View>
          <Text style={{fontWeight: '100', fontSize: 12, marginBottom: -5}}>
            Proprietário(a)
          </Text>
          {this.prop()}
        </View>
      ...
      <View
        style={{borderBottomWidth: 0.2, elevation: 2, borderColor: '#7D44FF'}}
      />
    </View>
  );
};
